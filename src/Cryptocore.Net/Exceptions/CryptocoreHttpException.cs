...
{
    public class CryptocoreHttpException : CryptocoreApiException
    {
        ...
        public CryptocoreHttpException(HttpStatusCode statusCode, string reasonPhrase)
        ...
        public CryptocoreHttpException(HttpStatusCode statusCode, string reasonPhrase, int errorCode, string errorMessage)
